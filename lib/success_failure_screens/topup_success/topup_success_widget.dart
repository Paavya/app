...
class TopupSuccessWidget extends StatefulWidget {
  const TopupSuccessWidget({Key? key}) : super(key: key);

  @override
  _TopupSuccessWidgetState createState() => _TopupSuccessWidgetState();
}
...
class _TopupSuccessWidgetState extends State<TopupSuccessWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'topup_success'});
                  ...
                  children: [
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'TOPUP_SUCCESS_BACK_TO_HOME_BTN_ON_TAP');
