...
import 'transfer_success_model.dart';
export 'transfer_success_model.dart';

class TransferSuccessWidget extends StatefulWidget {
  const TransferSuccessWidget({Key? key}) : super(key: key);

  @override
  _TransferSuccessWidgetState createState() => _TransferSuccessWidgetState();
}

class _TransferSuccessWidgetState extends State<TransferSuccessWidget> {
  late TransferSuccessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransferSuccessModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'transfer_success'});
                                  ...
                                  Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: RiveAnimation.asset(
                                        'assets/rive_animations/login_screen_character_(2).riv',
                                        artboard: 'Artboard',
                                        fit: BoxFit.cover,
                                        controllers:
                                            _model.riveAnimationControllers1,
                                      ),
                                    ),
                                  ),
                                  Align(
                                      ...
                                      child: Stack(
                                        children: [
                                          Container(
                                            ...
                                            height: 668.0,
                                            child: RiveAnimation.asset(
                                              'assets/rive_animations/2959-6204-confetti-mobile.riv',
                  ...
                  children: [
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'TRANSFER_SUCCESS_BACK_TO_HOME_BTN_ON_TAP');
                        ...
                        options: FFButtonOptions(
                          ...
                          textStyle:
                              FlutterFlowTheme.of(context).titleSmall.override(
                                    ...
                                    color: FlutterFlowTheme.of(context).tabBgs,
                                  ),
                          elevation: 0.0,
