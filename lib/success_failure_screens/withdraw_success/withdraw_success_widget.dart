...
import 'withdraw_success_model.dart';
export 'withdraw_success_model.dart';

class WithdrawSuccessWidget extends StatefulWidget {
  const WithdrawSuccessWidget({Key? key}) : super(key: key);

  @override
  _WithdrawSuccessWidgetState createState() => _WithdrawSuccessWidgetState();
}

class _WithdrawSuccessWidgetState extends State<WithdrawSuccessWidget> {
  late WithdrawSuccessModel _model;
