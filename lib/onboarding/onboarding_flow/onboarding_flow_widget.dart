...
class OnboardingFlowWidget extends StatefulWidget {
  const OnboardingFlowWidget({Key? key}) : super(key: key);

  @override
  _OnboardingFlowWidgetState createState() => _OnboardingFlowWidgetState();
}
                                                          ...
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(
                                                                      8.0),
                                                          child: Image.asset(
                                                            'assets/images/iphone_13_mini_1.png',
                                                            width: 300.0,
                                                            height: 344.0,
                                                            fit: BoxFit.contain,
                                                          ),
                                                    ...
                                                    ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              8.0),
                                                      child: Image.asset(
                                                        'assets/images/Ilustration_(2).png',
                                                        width: 300.0,
                                                        height: 348.0,
                                                        fit: BoxFit.contain,
                                                      ),
