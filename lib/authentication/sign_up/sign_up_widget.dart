...
class SignUpWidget extends StatefulWidget {
  const SignUpWidget({
    ...
    bool? termsAgreement,
  })  : this.termsAgreement = termsAgreement ?? false,
        super(key: key);
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 4.0, 0.0),
                                    child: TextFormField(
                                      controller: _model.fullnameController1,
                                      ...
                                      onFieldSubmitted: (_) async {
                                        ...
                                        final user = await authManager
                                          ...
                                          context,
                                          _model.fullnameController1.text,
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        4.0, 0.0, 0.0, 0.0),
                                    child: TextFormField(
                                      controller: _model.fullnameController2,
                                      ...
                                      onFieldSubmitted: (_) async {
                                        ...
                                        final user = await authManager
                                            .createAccountWithEmail(
                                          context,
                                          _model.fullnameController2.text,
                                          _model.passwordTextController.text,
                                        );
                                        if (user == null) {
                                          return;
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(50.0, 16.0, 50.0, 8.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
