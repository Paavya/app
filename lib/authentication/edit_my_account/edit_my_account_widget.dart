...
import 'edit_my_account_model.dart';
export 'edit_my_account_model.dart';

class EditMyAccountWidget extends StatefulWidget {
  ...
  @override
  _EditMyAccountWidgetState createState() => _EditMyAccountWidgetState();
}

class _EditMyAccountWidgetState extends State<EditMyAccountWidget> {
  late EditMyAccountModel _model;
