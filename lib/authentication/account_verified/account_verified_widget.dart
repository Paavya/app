...
class AccountVerifiedWidget extends StatefulWidget {
  const AccountVerifiedWidget({Key? key}) : super(key: key);

  @override
  _AccountVerifiedWidgetState createState() => _AccountVerifiedWidgetState();
}
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(24.0, 100.0, 0.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Stack(
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(24.0, 200.0, 24.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Expanded(
