...
import 'card_confirm_topup_model.dart';
export 'card_confirm_topup_model.dart';

class CardConfirmTopupWidget extends StatefulWidget {
  const CardConfirmTopupWidget({Key? key}) : super(key: key);

  @override
  _CardConfirmTopupWidgetState createState() => _CardConfirmTopupWidgetState();
}

class _CardConfirmTopupWidgetState extends State<CardConfirmTopupWidget> {
  late CardConfirmTopupModel _model;
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(24.0, 24.0, 4.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(12.0, 50.0, 12.0, 12.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    mainAxisAlignment: MainAxisAlignment.center,
